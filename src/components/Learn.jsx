  ...
  <div className="bg-primary text-white">
    ...
    <div className="px-3">
      ...
      <div className="mb-3">
        ...
        <div>
          <img src={castling} alt="Castle Movement" style={{ width: '100%' }} />
        </div>
      </div>
      <div className="mb-3">
        ...
        <div>
          <img src={pawnPromotion} alt="Pawn Promotion" style={{ width: '100%' }} />
        </div>
      </div>
      <div className="mb-3">
        ...
        <div>
          <img src={enPassant} alt="En passant" style={{ width: '100%' }} />
        </div>
      </div>
    </div>
    <div className="px-3">
