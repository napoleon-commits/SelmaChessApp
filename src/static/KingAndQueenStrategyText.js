export default {
    ...
    items: [
        {
            lessonHeader: `Don't Develop Your Queen Early`,
            demo: [
                {
                    fens: [
        ...
        {
            lessonHeader: `Beat Back Early Queen Aggression`,
            demo: [
                {
                    fens: [
        ...
        {
            lessonHeader: `Safeguard Your Queen`,
            demo: [
                {
                    fens: [
        ...
        {
            lessonHeader: `Don't Risk Your King!`,
            demo: [
                {
                    fens: [
                ...
                },
                {
                    ...
                    text: `
                        As this next position shows, white has continued the attack by capturing the black g6-pawn with the white pawn on f5 (f5xg6). Black simply does not have time to capture the white Rook on h1 because any move by the white pawn on g6 will be checkmate!
        ...
        {
            lessonHeader: `Castling Long or Short`,
            demo: [
                {
                    fens: [
        ...
        {
            lessonHeader: `Don't Push Your Pawns in Front of a Castled King`,
            demo: [
                {
                    fens: [
