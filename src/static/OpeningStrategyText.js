export default {
    ...
    items: [
        {
            header: 'Fight for the Center of the Board',
            subtitle: `
                The center of the chessboard forms the high ground in a chess battle. If you dominate the center of the board, your attacks are very likely to succeed.
            `,
            lessonHeader: `
            ...
            demo: [
                {
                    ...
                    text: `
                        The absolute center consists of the four squares highlighted here (d4, d5, e4, and e5). From the very beginning of the game, you want to fight for control over these squares.
                    `,
                },
                {
                    ...
                    text: `
                        ...
                        the white Queen on d1 gain the ability to move out. Although you have already learned not to develop your Queen too early, having these early mobility options often proves useful. For exam- ple, black should not reply with the move b7 to b5 (1.b7-b5) because white’s Bishop on f1 would be able to capture it.
                    `,
                },
                {
                    fens: ['rnbqkbnr/pppppppp/8/8/3PP3/8/PPP2PPP/RNBQKBNR w KQkq - 0 1'],
                    text: `
                        In addition to staking a claim in the center, white’s e2-e4 opening move has an important threat. Here, the threat is simply the move that white would make if white could move again—d2 to d4 (2.d2-d4)—taking full com- mand over the center of the board. The two pawns together, if unopposed, occupy two of the squares in the center and exercise control over the other two center squares.
                    `,
                },
                {
                    fens: ['rnbqkbnr/pppppppp/8/8/3P4/8/PPP1PPPP/RNBQKBNR w KQkq - 0 1'],
                    text: `
                        White’s other main possibility at the beginning of the game is d2 to d4 (1.d2-d4). Here, too, the pawn occupies one of the central squares and helps control another key square, e5. In this case, the move provides additional mobil- ity for the white Bishop on c1 and carries the obvious second move threat of e2 to e4 (2.e2-e4).
                    `,
                }
            ],
        },
        {
            header: 'An Ideal Setup',
            subtitle: `
                You won’t always be able to obtain this ideal setup (described in detail below) for your pieces; in fact, the moves that you make will depend on what your opponent does. But the fol- lowing position represents a goal, an ideal position that you might want to obtain if your opponent puts up very little resistance.
            `,
            lessonHeader: `Your Goal`,
            demo: [
                {
        ...
        {
            header: 'Knights Before Bishops',
            subtitle: `
                As my Uncle Joe used to say, “Knights before Bishops, Knights before Bishops, Knights before Bishops.” I think that he said it three times because he really meant it. There are exceptions, but moving Bishops first can cost time later because the Bishop may be posted on a square that in a few moves, if not immediately, could be attacked. So make my uncle happy and move your Knights before you move your Bishops!
            `,
        ...
        },
        {
            ...
            demo: [
                ...
                },
                {
                    ...
                    text: `
                        Here is the position after Knight g8 to f6 (Ng8-f6). White can respond powerfully with pawn e4 to e5 (e4-e5), taking further com- mand over the center and forcing the poor f6- Knight (Nf6) to move again. Notice that if the Knight moves again to d5, g4, or h5, it will be subject to another attack from a white pawn.
                    `,
                },
                {
        ...
        {
            header: 'Complete Your Development Before You Attack',
            subtitle: `
                All too often, beginners tend to begin their attacks before they have com- pleted developing their pieces. Be sure to develop first, then attack.
            `,
        ...
        },
        {
            header: 'Gain Time',
            subtitle: `
                As you are developing, pay attention to your opponent’s moves. Is your opponent threatening to capture one of your pieces? Did your opponent leave a piece undefended where it can be successfully captured at little or no cost to you? Almost as important, can you gain time by forcing your oppo- nent to retreat?
            `,
            lessonHeader: `Alekhine’s Defense`,
            demo: [
                {
                    fens: [
                    ...
                    text: `
                        In this position, black has responded to white’s opening move of pawn e2 to e4 (1.e2- e4) with the very sharp Knight g8 to f6 (1.Ng8-f6). This opening—known as Alekhine’s Defense, after former world champion Alexander Alekhine—prevents white from play- ing a second move of pawn d2 to d4 (2.d2- d4) because black’s first move threatens to capture the white pawn on e4.
                        White could decide to defend the e4-pawn with pawn d2 to d3 (2.d2-d3), but the white d-pawn really would like to develop directly to d4. White therefore decides to gain time by advancing the e-pawn for a second time to e5 (e4-e5). The second advance of the white e- pawn might appear to break the rule of devel- oping a piece only once, but the advance does present the black Knight with a problem.
                    `,
                },
                {
                    fens: ['rnbqkb1r/pppppppp/8/2n1P3/8/3P4/PPP2PPP/RNBQKBNR w KQkq - 0 1'],
                    text: `
                        Black mistakenly advances the attacked Knight to e4 (Nf6-e4). Knight f6 to d5 (Nf6-d5) is the main line, although the Knight can also be attacked there by the white pawns. In this position, white can continue to attack the black Knight with its d2-pawn (3.d2-d3), gain- ing time for rapid development. Here is the position after the third moves by white (d2- d3) and black (Ne4-c5). (These moves can be notated together as 3.d2-d3 Ne4-c5).
                        The poor black Knight is being forced to move again and again, while white is successfully establishing a strong pawn center. White’s next move is likely to be d3 to d4 (4.d3-d4), fol- lowed by the rapid deployment of the white Knights to f3 and c3.
                    `,
                }
            ],
        },
        {
            header: 'Limit Exchanges',
            subtitle: `
                Many beginners feel that they ought to exchange pieces—Knights for Knights, Bishops for Bishops, Rooks for Rooks—whenever they have the opportunity. As a general rule, exchanges are not often advantageous because they only help an opponent gain time for development.
            `,
        ...
        },
        {
            ...
            demo: [
                ...
                },
                {
                    ...
                    text: `
                        Here is the same game a few moves later. Note that the black f-pawns are indeed dou- bled. In compensation, black has aggressively posted the dark-squared Bishop on g7. This Bishop is quite strong because it is well posted on the long diagonal and because white no longer has a dark-squared Bishop to challenge it. Black may not be able to castle safely on the Kingside, but black could later in the game be able to post a Rook or even dou- ble Rooks on the open g-file. Note also that black’s f5-pawn is preventing white from developing normally with e3-e4.
